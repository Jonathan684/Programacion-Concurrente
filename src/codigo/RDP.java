...
//    }
	...
	public boolean Disparar(int transicion){
		...
		{
			if(esTemporal(transicion))resetEsperando(transicion);
			...
			sensibilizar();
			actualiceSensibilizadoT();//Comprueba si disparo de esta transicion ha habilitado el contador de trasiciones temporales sucesivas
					 ...
					 if(r=='(') {
						for(int z =k ; z<line.length() ; z++) {
							 ...
							 if(h==')') {
								 ...
								 //System.out.println("Comparacion de corte Inv "+ Inv);
